...
const int _ringStereoAtoms = 34; // int vect Canon/Chiral/MolHash/MolOps//Renumber//RWmol
...
// SLN
const int _AtomID = 64; // unsigned int SLNParser
const int _starred = 65; // atom int COMPUTED (SLN)
const int _SLN_s = 66; // string SLNAttribs (chiral info)
const int _Unfinished_SLN_ =67; // int (bool)

// Smarts Smiles
const int _brokenChirality = 68; // atom bool
const int isImplicit = 69;  // atom int (bool)
const int smilesSymbol = 70; // atom string (only used in test?)

// Tripos
const int _TriposAtomType = 71; // string Mol2FileParser
// missing defs for _TriposAtomName//_TriposPartialCharge...


///////////////////////////////////////////////////////////////
// misc props
const int TWOD = 72; // need THREED -> confusing using in TDTMol supplier
                      //  converge with _2DConf?
const int BalabanJ = 73; // mol double
const int BalanbanJ = 74; // typo!! fix...

const int Discrims = 75; // FragCatalog Entry
