...
using namespace ForceFields::UFF::Utils;
...
bool getUFFBondStretchParams(const ROMol &mol, unsigned int idx1,
  ...
  if (res) {
    ...
    uffBondStretchParams.r0 =
        calcBondRestLength(bondOrder, paramVect[0], paramVect[1]);
    uffBondStretchParams.kb = calcBondForceConstant(
...
bool getUFFAngleBendParams(const ROMol &mol, unsigned int idx1,
  ...
  if (res) {
    ...
    uffAngleBendParams.ka = calcAngleForceConstant(
...
bool getUFFTorsionParams(const ROMol &mol, unsigned int idx1, unsigned int idx2,
  ...
  if (res) {
    ...
    if ((hyb[0] == RDKit::Atom::SP3) && (hyb[1] == RDKit::Atom::SP3)) {
      ...
      if (((int)(bondOrder * 10) == 10) && isInGroup6(atNum[0]) &&
          isInGroup6(atNum[1])) {
        double V2 = 6.8;
        double V3 = 6.8;
        if (atNum[0] == 8) V2 = 2.0;
      ...
      uffTorsionParams.V =
          equation17(bondOrder, paramVect[0], paramVect[1]);
    } else {
      ...
      if ((int)(bondOrder * 10) == 10) {
        ...
        if (((hyb[0] == RDKit::Atom::SP3) && isInGroup6(atNum[0]) &&
             (!isInGroup6(atNum[1]))) ||
            ((hyb[1] == RDKit::Atom::SP3) && isInGroup6(atNum[1]) &&
             (!isInGroup6(atNum[0])))) {
          uffTorsionParams.V =
              equation17(bondOrder, paramVect[0], paramVect[1]);
        }
...
bool getUFFInversionParams(const ROMol &mol, unsigned int idx1,
  ...
  if (res) {
    ...
    boost::tuple<double, double, double, double> invCoeffForceCon =
        calcInversionCoefficientsAndForceConstant(at2AtomicNum,
                                                         isBoundToSP2O);
...
bool getUFFVdWParams(const ROMol &mol, unsigned int idx1, unsigned int idx2,
  ...
  if (res) {
    uffVdWParams.x_ij = calcNonbondedMinimum(paramVect[0], paramVect[1]);
    uffVdWParams.D_ij = calcNonbondedDepth(paramVect[0], paramVect[1]);
  }
  return res;
}
}
